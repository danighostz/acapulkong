...
const profile = {
    // --- IDENTIDAD ---
    name: "Acapulkong", // <-- CAMBIAR NOMBRE
    description: "Todo lo que debes saber de Acapulco sin censura", // <-- CAMBIAR DESCRIPCIÓN
    
    // --- IMÁGENES ---
    logo: "img/logo.png", // <-- CAMBIAR LOGO (2000x2000px)
    background: "img/fondo.jpg", // <-- CAMBIAR IMAGEN DE FONDO (9:16)
    ...
    socialLinks: [
        {
            name: "Facebook", // <-- TEXTO DEL BOTÓN
            url: "https://facebook.com/acapulkong", // <-- ENLACE DE FACEBOOK
            icon: "fab fa-facebook-f",
            color: "#1877F2"
        },
        {
            name: "Instagram",
            url: "https://instagram.com/acapulkong",
            icon: "fab fa-instagram",
            color: "#E1306C"
        },
        {
            name: "TikTok",
            url: "https://tiktok.com/@acapulkong",
            icon: "fab fa-tiktok",
            color: "#ffffff"
        },
        {
            name: "YouTube",
            url: "https://www.youtube.com/@acapulkong",
            icon: "fab fa-youtube",
            color: "#FF0000"
        }
